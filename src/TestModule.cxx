...
//*****************************************
 ...
 //CENTRAL Trigger
      ...
      pass_trigger450 = (trigger450_sel->passes(event) && pt_ave>trg_thresh[8] && pt_ave<trg_thresh[9]); // && abs(probejet_eta) < 2.853);
      pass_trigger500 = (trigger500_sel->passes(event) && pt_ave>trg_thresh[9]); // && abs(probejet_eta) < 2.853);
