...
protected:
  ...
  Event::Handle<int> tt_event;  Event::Handle<int> tt_run;
  ...
  sel(ctx)
{
  ...
  if(isMC){
	...
	else if(JEC_Version == "Summer16_07Aug2017_V3"){
	  JEC_corr              = JERFiles::Summer16_07Aug2017_V3_L123_AK4PFchs_MC;           //noRes only for DATA ;), only one version for MC for deriving Summer16_23Sep2016
	  JEC_corr_L1RC         = JERFiles::Summer16_07Aug2017_V3_L1RC_AK4PFchs_MC;           
	  // //dummies, in this version, MC is not split
	  // JEC_corr_BCD          = JERFiles::Summer16_07Aug2017_V3_L123_AK4PFchs_MC;          
	  // JEC_corr_BCD_L1RC     = JERFiles::Summer16_07Aug2017_V3_L1RC_AK4PFchs_MC;
	  // JEC_corr_EFearly      = JERFiles::Summer16_07Aug2017_V3_L123_AK4PFchs_MC;
	  // JEC_corr_EFearly_L1RC = JERFiles::Summer16_07Aug2017_V3_L1RC_AK4PFchs_MC;
	  // JEC_corr_FlateG       = JERFiles::Summer16_07Aug2017_V3_L123_AK4PFchs_MC;
	  // JEC_corr_FlateG_L1RC  = JERFiles::Summer16_07Aug2017_V3_L1RC_AK4PFchs_MC;
	  // JEC_corr_H            = JERFiles::Summer16_07Aug2017_V3_L123_AK4PFchs_MC;
	  // JEC_corr_H_L1RC       = JERFiles::Summer16_07Aug2017_V3_L1RC_AK4PFchs_MC;
	  cout << "This is MC, JECs used are: ";
	  for(unsigned int i=0; i<JEC_corr.size(); i++) cout << JEC_corr[i] << ", ";
	  cout << endl;
	}
	...
	//JEC-Version MC: Legacy 2017
	  ...
	  JEC_corr              = JERFiles::Summer16_07Aug2017_V3_L123_AK4PFchs_MC;               //ReReco Data + Summer16 MC V7
	  JEC_corr_L1RC         = JERFiles::Summer16_07Aug2017_V3_L1RC_AK4PFchs_MC;
	  // //dummies, in this version, MC is not split
	  // JEC_corr_BCD          = JERFiles::Summer16_07Aug2017_V3_L123_AK4PFchs_MC;
	  // JEC_corr_BCD_L1RC     = JERFiles::Summer16_07Aug2017_V3_L1RC_AK4PFchs_MC;
    ...
    */
	...
	//JEC-Version Data: Legacy 2017
	  ...
	  JEC_corr              = JERFiles::Summer16_07Aug2017_V3_GH_L123_noRes_AK4PFchs_DATA;  //ReReco Data + Moriond17 MC V7
	  JEC_corr_L1RC         = JERFiles::Summer16_07Aug2017_V3_GH_L1RC_AK4PFchs_DATA;
	  JEC_corr_BCD          = JERFiles::Summer16_07Aug2017_V3_BCD_L123_noRes_AK4PFchs_DATA;
	  JEC_corr_BCD_L1RC     = JERFiles::Summer16_07Aug2017_V3_BCD_L1RC_AK4PFchs_DATA;
	  JEC_corr_EFearly      = JERFiles::Summer16_07Aug2017_V3_EF_L123_noRes_AK4PFchs_DATA;
	  JEC_corr_EFearly_L1RC = JERFiles::Summer16_07Aug2017_V3_EF_L1RC_AK4PFchs_DATA;
	  JEC_corr_FlateG       = JERFiles::Summer16_07Aug2017_V3_GH_L123_noRes_AK4PFchs_DATA;
	  JEC_corr_FlateG_L1RC  = JERFiles::Summer16_07Aug2017_V3_GH_L1RC_AK4PFchs_DATA;
	  JEC_corr_H            = JERFiles::Summer16_07Aug2017_V3_GH_L123_noRes_AK4PFchs_DATA;
	  JEC_corr_H_L1RC       = JERFiles::Summer16_07Aug2017_V3_GH_L1RC_AK4PFchs_DATA;
	}
	...
	//JEC-Version Data: V4
	  ...
	  //closure
	  JEC_corr              = JERFiles::Summer16_03Feb2017_V6_G_L123_AK4PFchs_DATA;              //ReReco Data + Summer16 V4
	  ...
	  //closure
	  JEC_corr              = JERFiles::Summer16_07Aug2017_V3_GH_L123_AK4PFchs_DATA;              //ReReco Data + Summer16 V7
	  JEC_corr_L1RC         = JERFiles::Summer16_07Aug2017_V3_GH_L1RC_AK4PFchs_DATA;
	  JEC_corr_BCD          = JERFiles::Summer16_07Aug2017_V3_BCD_L123_AK4PFchs_DATA;
	  JEC_corr_BCD_L1RC     = JERFiles::Summer16_07Aug2017_V3_BCD_L1RC_AK4PFchs_DATA;
	  JEC_corr_EFearly      = JERFiles::Summer16_07Aug2017_V3_EF_L123_AK4PFchs_DATA;
	  JEC_corr_EFearly_L1RC = JERFiles::Summer16_07Aug2017_V3_EF_L1RC_AK4PFchs_DATA;
	  JEC_corr_FlateG       = JERFiles::Summer16_07Aug2017_V3_GH_L123_AK4PFchs_DATA;
	  JEC_corr_FlateG_L1RC  = JERFiles::Summer16_07Aug2017_V3_GH_L1RC_AK4PFchs_DATA;
	  JEC_corr_H            = JERFiles::Summer16_07Aug2017_V3_GH_L123_AK4PFchs_DATA;
	  JEC_corr_H_L1RC       = JERFiles::Summer16_07Aug2017_V3_GH_L1RC_AK4PFchs_DATA;
	  cout << "JEC for DATA: Summer16_07Aug2017_V3_BCD/EFearly/FlateG/H_L123_AK4PFchs_DATA;" << endl;
	}
	...
	if(JEC_Version == "Summer16_03Feb2017_V4"){
	  JEC_corr              = JERFiles::Summer16_03Feb2017_V4_G_L123_noRes_AK8PFchs_DATA;              //ReReco Data + Summer16 V4
  ...
  */
  ...
  if(isMC){
    if(JEC_Version == "Summer16_23Sep2016_V4") 
      ...
      if(JEC_Version == "Summer16_03Feb2017_V3" || JEC_Version == "Summer16_03Feb2017_V4" || JEC_Version == "Summer16_03Feb2017_V5" || JEC_Version == "Summer16_03Feb2017_V6" || JEC_Version == "Summer16_03Feb2017_V7" || JEC_Version == "Summer16_07Aug2017_V3") 
	jetER_smearer.reset(new GenericJetResolutionSmearer(ctx, "jets", "genjets", true, JERSmearing::SF_13TeV_2016_03Feb2017)); 
  ...
  h_final.reset(new JECAnalysisHists(ctx,"Final"));
    ...
    tt_event = ctx.declare_event_output<int>("event");
...
//#####################################################################################################################
 ...
 //fill the containers
    ...
    event.set(tt_event,event.event);
...
//DiJet-Events
    ...
    if(!event.isRealData && event.genInfo->binningValues().size()>0){
      ...
      if(event.genInfo->binningValues()[0]>0 && pt_ave>event.genInfo->binningValues()[0]*10) return false; //TEST: suppress crazy events
    }
    // h_nocuts->fill(event);
    // h_lumi_nocuts->fill(event);
...
//######################################################################################################################################
	...
	//if(dr_min <= dr_cut) {
	if(dr_min <= dr_cut && idx_genp_min>-1) {//TEST it does not make sense to look at status 1 particles, since we know nothing about them
	...
	//	if(debug) cout<<"1 event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt() = "<<event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt()<<endl;
	response_probejet = jet_probe->pt() / event.genparticles->at(idx_matched_jets[idx_probejet]).pt();
	//	if(debug) cout<<"2 event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt() = "<<event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt()<<endl;
	probejet_ptptcl = event.genparticles->at(idx_matched_jets[idx_probejet]).pt();
	//	if(debug) cout<<"3 event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt() = "<<event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt()<<endl;
	probejet_statusptcl = event.genparticles->at(idx_matched_jets[idx_probejet]).status(); 
	//	if(debug) cout<<"4 event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt() = "<<event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt()<<endl;
	probejet_ptgen = event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt();
	//	if(debug) cout<<"5 event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt() = "<<event.genjets->at(idx_matched_RecoGenjets[idx_probejet]).pt()<<endl;
      }
	...
	if(debug) cout << "3rd is jet no. " << 2 << ", alpha = " << event.get(tt_alpha) << ", flavor of the 3rd jet = " << flavor_3rdjet <<", status = "<<jet3_statusptcl<< endl;
      }
      else{
	flavor_3rdjet = -1;  
      }
    ...
    if(debug) {
      ...
      cout<<"parton - GEN jet "<<event.get(tt_parton1_genjetID)<<" "<<event.get(tt_parton2_genjetID)<<" parton - RECO jet "<<event.get(tt_parton1_jetID)<<" "<<event.get(tt_parton2_jetID)<<endl;
      cout << endl << "--------- END EVENT --------" << endl << endl;
    }
